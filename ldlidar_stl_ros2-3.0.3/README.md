...
将下载的lidar_stl_ros2-x.x.x.zip ROS 包复制到home目录，或你能找到的目录。

```bash
cd ~

unzip lidar_stl_ros2-x.x.x

mkdir -p ldlidar_ros_ws/src

cd ldlidar_ros_ws/src

cp ../../lidar_stl_ros2-x.x.x/* ./ -r
...
Copy the downloaded lidar_stl_ros2-x.x.x.zip ROS package to the home directory, or to a directory you can find.
